...
## About Mental Health Management System

This is a professional mental health management system built for psychological counseling platforms. The system provides comprehensive management capabilities for user management, forum post moderation, psychological consultation records, and system analytics. Based on Vue 3, TypeScript, and Element Plus, it offers a modern and user-friendly administrative interface for mental health service providers.

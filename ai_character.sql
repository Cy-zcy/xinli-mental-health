...
-- 向现有 chat_sessions 增加 character_id（若列已存在会报错，忽略即可）
ALTER TABLE `chat_sessions` ADD COLUMN `character_id` BIGINT DEFAULT 1 COMMENT '绑定的AI人设ID，关联ai_character' AFTER `title`;
